...
function Technologies() {
  ...
  return (
    <main className="container mx-auto max-width pt-10 pb-20 ">
      <section>
        <div className="flex" onClick={toggleDescription1}>
        <h1 className="text-2xl text-dark-heading dark:text-light-heading md:text-4xl xl:text-5xl xl:leading-tight font-bold d-inline hover:cursor-pointer"
        >
          Tech Stack  
        </h1>
        <h1 className="pt-3 pl-2 hover:cursor-pointer">▼</h1>
        </div>
        
        {showDescription1 && (
          <p className="text-justify py-2 lg:max-w-3xl ">
            I am a full stack developer with experience in a wide range of technologies. On the front end, I use HTML, CSS, Bootstrap, JavaScript and React as my main library. For the deployment of my projects, I am familiar with both GitHub Pages and Firebase.<br></br>
            As for the backend, I specialize in Java and the Spring ecosystem with MySql as data base. I have experience with Spring Boot, Spring Security and Spring Cloud. Additionally, I have implemented security in some of my personal projects using the JWT library. I have built applications using both monolithic and microservices architectures, leveraging tools like Feign.<br></br>
            My projects also incorporate various design patterns, such as MVC, Data Transfer Object,dependency injection, builder, and in the field of microservices I have worked with Service Registry and Discovery using Eureka, Load Balancing with Spring Cloud Balancer and Circuit Breaker with Resilience4J. I have also worked with API Gateway and Config Server. Finally, I have used Render to deploy projects and have gained knowledge about Docker.
          </p>
        )}
      </section>
      <section className="grid grid-cols-5 md:grid-cols-6 lg:grid-cols-7 items-center gap-10 pt-6">
        ...
        <img src={springboot} title="Spring Boot" alt="" />
        <img src={springsec} title="Spring Security" alt="" />
        <img src={springcloud} title="Spring Cloud" alt="" />
        <img src={jwt} title="Json Web Token" alt="" />
        <img src={mysql} title="MySql" alt="" />
        
      </section>
      <section>
      <div className="flex mt-10" onClick={toggleDescription2}>
      <h1 className="text-2xl text-dark-heading dark:text-light-heading md:text-4xl xl:text-5xl xl:leading-tight font-bold hover:cursor-pointer">
          Tools
        </h1>
        <h1 className="pt-3 pl-2 hover:cursor-pointer">▼</h1>
      </div>
      {showDescription2 && (
          <p className="text-justify py-2 lg:max-w-3xl">
            These are some of the tools I have used throughout my journey as a developer. Version control with Git. Deployments with Firebase, Github Pages, Render, Clever Cloud and Docker. Code editors such as Visual Studio Code, IntelliJ Idea and Apache NetBeans. Testing endpoints with Postman. Database management with MySql Workbench and DBeaver. Management of packages or dependencies with NPM and Maven.
          </p>
        )}
      </section>
      <section className="grid grid-cols-5 md:grid-cols-6 lg:grid-cols-7 items-center gap-10 pt-6">
        ...
        <img src={maven} title="Maven" alt="Maven" />
        <img src={postman} title="Postman" alt="Postman" />
        <img src={intellij} title="IntelliJ Idea" alt="IntelliJ Idea" />
        <img src={apache} title="Apache NetBeans" alt="Apache NetBeans" />
        <img src={dbeaver} title="DBeaver" alt="DBeaver" />
        <img src={workbench} title="MySql Workbench" alt="MySql Workbench" />
        ...
        <img src={clever} title="Clever Cloud" alt="Clever Cloud" />
