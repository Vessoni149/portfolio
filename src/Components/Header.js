  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <img className="w-14 bg-gradient" style={{ borderRadius: '50%'}} src={logos.logogradient} alt="logo" />
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-3 md:mr-3">
          
          <li className="m-0 pb-1 pr-1 pl-1  md:pb-0  rounded-md overflow-hidden hover:bg-gradient-to-r from-sky-500 via-purple-500 to-pink-600 transition-all duration-300 ease-in-out">
            <NavLink to="/about" onClick={toggleClass}>
              About
            </NavLink>
          </li>
          <li className="pb-1 pr-1 pl-1  md:pb-0  rounded-md overflow-hidden hover:bg-gradient-to-r from-sky-500 via-purple-500 to-pink-600 transition-all duration-300 ease-in-out">
